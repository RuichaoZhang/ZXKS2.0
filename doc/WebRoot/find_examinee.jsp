...
<table>
	...
	<div class="table-responsive">
	   ...
	   <c:forEach items="${page.records}" var="c" varStatus="vs">
		...
		<a href="${pageContext.request.contextPath}/ExamineeManagementServlet?operate=findAll_examinee&pageNum=1">首页</a>&nbsp;
		<a href="${pageContext.request.contextPath}/ExamineeManagementServlet?operate=findAll_examinee&pageNum=${page.pageNum - 1 == 0 ? 1 : page.pageNum - 1}">上一页</a>&nbsp;
		<a href="${pageContext.request.contextPath}/ExamineeManagementServlet?operate=findAll_examinee&pageNum=${page.pageNum + 1 <= page.totalPage ? page.pageNum + 1 : page.totalPage}">下一页</a>&nbsp;
		<a href="${pageContext.request.contextPath}/ExamineeManagementServlet?operate=findAll_examinee&pageNum=${page.totalPage}">尾页</a>&nbsp;
		<select id="s1">
