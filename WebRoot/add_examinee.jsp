...
<form action="${pageContext.request.contextPath}/ExamineeManagementServlet"
   ...
   <div class="form-group">
    ...
    <div class="col-sm-3">
      <input type="tel"  name="examineeTelephone" class="form-control" maxlength="16" onblur="change('examineeTelephone')" placeholder="请输入正确的联系方式"
	  id="examineeTelephone" value="${examineeTelephone}"
	  >
    </div>
  </div>
  <div class="form-group">
